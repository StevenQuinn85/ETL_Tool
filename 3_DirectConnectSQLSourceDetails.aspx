<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="3_DirectConnectSQLSourceDetails.aspx.cs" Inherits="ELTManagement.DataEntryForms._3_DirectConnectSQLSourceDetails" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="wrapper">
            ...
            <div id="CenterContent">
                <div id="PageTitle"><h2>Enter SQL Server Source Details</h2></div>
                <div id ="PageContent">
                                    <table>
                    <tr>
