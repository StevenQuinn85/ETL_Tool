<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="4_DestinationSelection.aspx.cs" Inherits="ELTManagement._4_DestinationSelection" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="wrapper">
            ...
            <div id="CenterContent">
                <div id="PageTitle"><h2>Select Destination Type</h2></div>
                <div id ="PageContent">
