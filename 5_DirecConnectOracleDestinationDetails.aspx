<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="5_DirecConnectOracleDestinationDetails.aspx.cs" Inherits="ELTManagement._5_DirecConnectOracleDestinationDetails" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="wrapper">
            ...
            <div id="CenterContent">
                <div id="PageTitle">
                    <h2>Enter Oracle Database Destination Details</h2>
                </div>
                <div id="PageContent">
                    <table>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><div id="tip_Database" class="toolTip"><asp:Label ID="lbl_DatabaseTip" runat="server">?</asp:Label></div></td>
                        </tr>
                        <tr>
