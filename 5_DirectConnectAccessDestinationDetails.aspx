<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="5_DirectConnectAccessDestinationDetails.aspx.cs" Inherits="ELTManagement._5_DirectConnectAccessDestinationDetails" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="wrapper">
            ...
            <div id="CenterContent">
                <div id="PageTitle"><h2>Enter Access Destination Details</h2></div>
                <div id ="PageContent">
                                    <table>
                    <tr>
                        <td>
