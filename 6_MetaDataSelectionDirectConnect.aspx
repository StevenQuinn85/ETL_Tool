<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="6_MetaDataSelectionDirectConnect.aspx.cs" Inherits="ELTManagement._6_MetaDataSelectionDirectConnect" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="wrapper">
            ...
            <div id="CenterContent">
                <div id="PageTitle"><h2>Select Metadata Input Method</h2></div>
                <div id ="PageContent">
