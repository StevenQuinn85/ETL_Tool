...
<%--                    Inserting a div with a script to display a processing image whilst the system is completing and import
                    ...
                    <div id="ProcessingImage" class ="center">
                        ...
                        <asp:UpdatePanel runat="server" ID="LoadingPanel">
                            ...
                            <ContentTemplate>
                                <div id="ExecuteButton" class="right"><asp:Button ID="btn_Execute" runat="server" Text="Execute" OnClick="btn_Execute_Click" /></div>
                                
                                <div><asp:Label ID="lbl_processing" runat="server" Text=""></asp:Label></div>
                            </ContentTemplate>
